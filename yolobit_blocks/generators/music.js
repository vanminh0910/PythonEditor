...
Blockly.Python['yolobit_music_play_built_in'] = function(block) {
...
Blockly.Python['yolobit_music_pitch'] = function(block) {
  Blockly.Python.definitions_['import_music'] = 'import music';
...
Blockly.Python['yolobit_music_play_list_of_notes'] = function(block) {
  Blockly.Python.definitions_['import_music'] = 'import music';
...
Blockly.Python['yolobit_music_reset'] = function(block) {
  Blockly.Python.definitions_['import_music'] = 'import music';
  var code = 'music.reset()\n';
  return code;
};

Blockly.Python['yolobit_music_stop'] = function(block) {
  Blockly.Python.definitions_['import_music'] = 'import music';
  var code = 'music.stop()\n';
  return code;
};

Blockly.Python['yolobit_music_set_tempo'] = function(block) {
  Blockly.Python.definitions_['import_music'] = 'import music';
...
Blockly.Python['yolobit_music_get_tempo'] = function(block) {
  Blockly.Python.definitions_['import_music'] = 'import music';
